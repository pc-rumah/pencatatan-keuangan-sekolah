    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('kelas.update', $item->id) }}" method="POST" data-parsley-validate>
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <label for="nama_kelas" class="col-form-label col-sm-2">Nama
                            Kelas</label>
                        <div class="col-sm-10">
                            <input type="text" name="nama_kelas" id="nama_kelas" value="{{ $item->nama_kelas }}"
                                class="form-control" placeholder="Masukan Nama Kelas" data-parsley-required="true"
